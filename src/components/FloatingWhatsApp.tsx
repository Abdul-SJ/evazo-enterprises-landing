...
export default function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="whatsapp-pulse fixed bottom-6 right-6 md:bottom-10 md:right-10 z-50 flex items-center gap-2.5 bg-whatsapp hover:bg-whatsapp-hover text-white font-bold rounded-full shadow-xl transition-colors duration-200"
